...
DomReady.ready(LW.lws3);LW.sb();if(!window['linkwithin_disable_tracking']){if(extra&&extra['tynt']){if('https:' == document.location.protocol ? 'https://' : 'http://'){Tynt=window.Tynt||[];Tynt.push("l!"+linkwithin_site_id);LW.c(extra['tynt']);}}
...
var e=document.createElement('script');e.type="text/javascript";e.src="//pagead2.googlesyndication.com/pagead/show_ads.js";document.body.appendChild(e);};LW.gcs=function(e,s){var cs;if(typeof e.currentStyle!='undefined')
{cs=e.currentStyle;}
else
